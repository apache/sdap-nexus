...
@nexus_handler
class WmtsTileServiceHandler(ResourceCachingHandler, SparkHandler):
    name = "WmtsTileServiceHandlerSpark"
    path = "/imaging/wmtsSpark"
    ...
    def calc(self, computeOptions, **args):
        ...
        if img_data is None:
            img = mapprocessingSpark.create_map(self._tile_service, self._sc, tile_tllr,
